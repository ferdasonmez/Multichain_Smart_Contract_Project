...
function add_member(account: string, chain_id: number, tags: string[]): Promise<void> {
  return contract.methods.addMember(account, chain_id, tags).call();
}
function remove_member(account: string, chain_id: number): Promise<void> {
